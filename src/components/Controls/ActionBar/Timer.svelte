...
<div class="timer-container">
  <button
    class="btn btn-round"
    on:click={() => ($gamePaused ? resumeGame() : pauseGame())}
    ...
    >
      {#if $gamePaused}
        <path
          ...
          stroke-width="2"
          d="M18.19 9.61L9.01 3.48A2.87 2.87 0 004.54 5.88v12.25a2.87 2.87 0 004.47 2.39l9.18-6.12a2.87 2.87 0 000-4.78v0z"
        />
      {:else}
