<script>
  ...
  const twitterLink =
    'https://twitter.com/intent/tweet?text=Check%20out%20this%20Sudoku%20puzzle!&url=' +
    encodedLink;
  const mailToLink =
    'mailto:?subject=A%20Sudoku%20puzzle%20for%20you&body=Here%27s%20a%20link%20to%20a%20Sudoku%20puzzle%20on%20sudoku.jonasgeiler.com%3A%0A%0A' +
    encodedLink;
...
<div class="code-container">
  <input
    class="input code-field"
    type="text"
    readonly
    value={sencode}
    on:click={(e) => select(e.target)}
  />
