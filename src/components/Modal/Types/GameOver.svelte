<script>
  ...
  const gameOverCelebration =
    GAME_OVER_CELEBRATIONS[Math.floor(Math.random() * GAME_OVER_CELEBRATIONS.length)];
...
<div class="game-data space-y-2">
  <div class="game-data-item">
    ...
    <div class="item-data">
      <div class="item-data-label">Time:</div>
  ...
  <div class="game-data-item">
    ...
    <div class="item-data">
      <div class="item-data-label">Difficulty:</div>
  ...
  <div class="game-data-item">
    ...
    <div class="item-data">
      <div class="item-data-label">Hints used:</div>
